<html>
<head>
<title>PHP Email Spoofer and Spammer</title>
...
<meta name="description" content="E mail Spoofer and Spammer">
</head>
...
An E-mail Spoofer + Spammer with Attachments by Gaurav Gupta
</marquee></font></a>
<?php
...
$file_tmp_name = $_FILES['file']['tmp_name'];
	...
	mail($to,$subject,$body,$headers);
        ...
        echo "<script type='text/javascript'>alert('Your message is successfully spammed and spoofed');</script>";
}
}
?>
<br>
